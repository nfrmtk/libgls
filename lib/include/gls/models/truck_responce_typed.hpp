...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(
    TTruckResponceTyped, resourcetype, id, title, mass, carrying_capacity,
    width, height, length, loading_width, loading_height, loading_length,
    ...
    created_at, updated_at, demo, user, type, uid, axles, hitch_load,
    hitch_max_load, hitch_distance, tractor)
}  // namespace gls
