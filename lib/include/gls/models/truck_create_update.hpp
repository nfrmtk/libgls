...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(
    TTruckCreateUpdate, id, title, mass, carrying_capacity, width, height,
    length, loading_width, loading_height, loading_length, indentation_width,
